package com.macro.common.generator;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setAuthor("macro");
        gc.setOutputDir(projectPath+"/com-common/src/main/java");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/com-common/src/main/java/com/macro/common/entity/mapping/"
