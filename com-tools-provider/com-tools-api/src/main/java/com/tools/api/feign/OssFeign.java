...
import com.tools.api.config.MultipartSupportConfig;
 ...
 * @Description 用户相关接口
 */
@FeignClient(value = "ossService", fallbackFactory = OssFeignClientFallbackFactory.class,configuration = MultipartSupportConfig.class)
